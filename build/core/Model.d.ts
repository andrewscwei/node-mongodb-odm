...
declare abstract class Model {
    ...
    static updateOne<T = {}, R = T>(query: Query<T>, update: DocumentFragment<T> | Update<T>, options?: ModelUpdateOneOptions): Promise<null | boolean | Document<R>>;
    ...
    static findAndReplaceOne<T = {}, R = T>(query: Query<T>, replacement?: DocumentFragment<T>, options?: ModelReplaceOneOptions): Promise<null | Document<R>>;
