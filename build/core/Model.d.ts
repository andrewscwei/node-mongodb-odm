...
declare abstract class Model {
    ...
    static findOne<T = {}, R extends T = T>(query?: Query<T>, options?: ModelFindOneOptions): Promise<null | Document<R>>;
    static findMany<T = {}, R extends T = T>(query?: Query<T>, options?: ModelFindManyOptions): Promise<Document<R>[]>;
    ...
    static updateOne<T = {}, R extends T = T>(query: Query<T>, update: DocumentFragment<T> | Update<T>, options?: ModelUpdateOneOptions): Promise<null | boolean | Document<R>>;
    static updateMany<T = {}, R extends T = T>(query: Query<T>, update: DocumentFragment<T> | Update<T>, options?: ModelUpdateManyOptions): Promise<Document<T>[] | boolean>;
    ...
    static findAndReplaceOne<T = {}, R extends T = T>(query: Query<T>, replacement?: DocumentFragment<T>, options?: ModelReplaceOneOptions): Promise<null | Document<R>>;
    ...
    static didInsertDocument<R>(doc: Document<R>): Promise<void>;
    static willUpdateDocument<T>(query: Query<T>, update: DocumentFragment<T> | Update<T>): Promise<[Query, DocumentFragment<T> | Update<T>]>;
    static didUpdateDocument<T, R>(prevDoc?: Document<T>, newDocs?: Document<R> | Document<R>[]): Promise<void>;
