...
declare abstract class Model {
    ...
    static findOne<T = {}>(query?: Query<T>, options?: ModelFindOneOptions): Promise<null | Readonly<Document<T>>>;
    static findMany<T = {}>(query?: Query<T>, options?: ModelFindManyOptions): Promise<Readonly<Document<T>>[]>;
    static insertOne<T>(doc?: DocumentFragment<T>, options?: ModelInsertOneOptions): Promise<null | Readonly<Document<T>>>;
    static insertMany<T = {}>(docs: DocumentFragment<T>[], options?: ModelInsertManyOptions): Promise<Readonly<Document<T>>[]>;
    static updateOne<T = {}>(query: Query<T>, update: DocumentFragment<T> | Update<T>, options?: ModelUpdateOneOptions): Promise<null | boolean | Readonly<Document<T>>>;
    static updateMany<T = {}>(query: Query<T>, update: DocumentFragment<T> | Update<T>, options?: ModelUpdateManyOptions): Promise<Readonly<Document<T>>[] | boolean>;
    static deleteOne<T = {}>(query: Query<T>, options?: ModelDeleteOneOptions): Promise<Readonly<Document<T>> | boolean | null>;
    static deleteMany<T = {}>(query: Query<T>, options?: ModelDeleteManyOptions): Promise<boolean | Readonly<Document<T>>[]>;
    static findAndReplaceOne<T = {}>(query: Query<T>, replacement?: DocumentFragment<T>, options?: ModelReplaceOneOptions): Promise<null | Readonly<Document<T>>>;
