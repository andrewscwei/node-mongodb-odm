 ...
 * @throws {TypeError} String value does not conform to the RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Length of string value exceeds the limit (only if validator is a number).
 * @throws {TypeError} String value is not an element of a set of strings (only if validator is an
 *                     array).
 * @throws {TypeError} Value is supposed to be a number but it is not.
 * @throws {TypeError} Number value should not have a RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Number value exceeds the maximum (only if validator is a number).
 * @throws {TypeError} Number value is not an element of a set of numbers (only if validator is an
 *                     array).
 * @throws {TypeError} Value is supposed to be a boolean but it is not.
 * @throws {TypeError} Boolean value should not have a RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Boolean value should not have a number validator (only if validator is a
 *                     number).
 * @throws {TypeError} Boolean value is not an element of a set of booleans (only if validator is an
 *                     array).
 * @throws {TypeError} Value is supposed to be a date but it is not.
 * @throws {TypeError} Date value should not have a RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Date value should not have a number validator (only if validator is a
 *                     number).
 * @throws {TypeError} Date value should not have an array validator (only if validator is an
 *                     array).
 * @throws {TypeError} Value is supposed to be an array but it is not.
 * @throws {TypeError} Array value should not have a RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Array value should not have a number validator (only if validator is a
 *                     number).
 ...
 * @throws {TypeError} Object value should not have a RegExp validator (only if validator is a
 *                     RegExp).
 * @throws {TypeError} Object value should not have a number validator (only if validator is a
 *                     number).
 * @throws {TypeError} Object value should not have an array validator (only if validator is an
 *                     array).
  ...
  switch (spec.type) {
    ...
    // If type is an array of a type, i.e. [Number].
      if (_.isArray(spec.type)) {
        ...
        // Ensure that every element within the array conforms to the specified type and passes the
        // validation test.
